...
function CheckAuthentication()
{
	...
	session_start();
	if ( isset($_SESSION['login_latorre']) && $_SESSION['login_latorre'] === true ) :
		return true;
	else :
		return false;
	endif;
...
*/
$baseUrl = 'http://localhost/ComercialMente/LATORRE/SISTEMA_LATORRE/uploads/ckfinder/'; //$baseUrl = '/ckfinder/userfiles/';
